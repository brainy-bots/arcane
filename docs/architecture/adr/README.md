...
| [004](004-global-partitioning-and-ml-seams.md) | 2026-07-12 | Global graph partitioning is the clustering core; per-entity scoring demoted to pair-move refinement; ML enters only at policy seams (predictor, region-selector, warm-start) behind rule-based baselines | Accepted |
